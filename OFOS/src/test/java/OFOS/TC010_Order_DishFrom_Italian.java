...
public class TC010_Order_DishFrom_Italian extends TC002_Verify_Login {
	
	@Test
	public void orderDish() throws InterruptedException
	{
		Home_Page home=new Home_Page(driver);
		home.getItalianLink().click();
		try {
		...
		home.getEatalyResturantLink().click();
		try {
		...
		dishes.getPinkSpaghettiGamberoniRestaurantAddtocart().click();
