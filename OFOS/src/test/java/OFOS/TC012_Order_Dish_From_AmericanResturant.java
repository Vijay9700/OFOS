...
public class TC012_Order_Dish_From_AmericanResturant extends TC002_Verify_Login{
	
	@Test
	public void orderDish() throws InterruptedException
	{
		Home_Page home=new Home_Page(driver);
		home.getAmericanLink().click();
		try {
		...
		home.getHighlandsBarGrillResturantLink().click();
		try {
		...
		dishes.getChickenMadeiraAddtocartButton().click();
